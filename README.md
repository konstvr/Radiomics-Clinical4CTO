...
## Please cite:
When using the code, trained model or demo please cite: Vrettos K., Kasioumi K., Galanakis N.,Kehagias E., Kontopodis N., Matthaiou N., Klontzas M., <i>Radiomics enhance the prediction of endovascular treatment success for femoropopliteal chronic total occlusions: a proof-of-concept study </i>, https://doi.org/10.1016/j.ejrad.2025.112496, European Journal of Radiology, 2025
